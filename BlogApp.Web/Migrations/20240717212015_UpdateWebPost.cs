...
{
    /// <inheritdoc />
    public partial class UpdateWebPost : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WebPosts", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "a55a9b26-e91f-4c9d-a21c-54eb82266278", null, "client", "client" },
                    { "f4e6b663-c680-4930-95b3-e5d77f92c2b5", null, "admin", "admin" }
                });
